...
<body>
	<table width="100%" height="70%" border="0" cellspacing="0"
		...
		<tr>
			<td><img width="100%"
				src="${pageContext.request.contextPath}/images/top_root.jpg">
			</td>

			<td width="100%"
				background="${pageContext.request.contextPath}/images/top_root.jpg">
			</td>
		</tr>
	</table>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="155" valign="bottom"
										background="${pageContext.request.contextPath}/images/mis_05b.jpg">
										用户名： <font color="blue"> ${root_session.username}</font>
									</td>
									<td width="155" valign="bottom"
										background="${pageContext.request.contextPath}/images/mis_05b.jpg">
										<a target="_top"
										href="${pageContext.request.contextPath}/admin/user/logout.action">注销</a></font>
									</td>
